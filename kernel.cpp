...
using namespace BlastOSPrototype;
using namespace BlastOSPrototype::common;
using namespace BlastOSPrototype::drivers;
using namespace BlastOSPrototype::hardwarecommunication;
using namespace BlastOSPrototype::gui;
using namespace BlastOSPrototype::net;
...
extern "C" void kernelMain(const void* multiboot_structure, uint32_t /*multiboot_magic*/)
{
    ...
    */
    ...
    while(1)
    {
            ...
            desktop.Draw(&vga);
        #ifdef kernelMain
        printf("ERROR! KERNELMAIN NOT FOUND!")
        #endif
    }
}
